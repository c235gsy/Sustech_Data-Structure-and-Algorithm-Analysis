    ...
    def get_node_at_point(self, point):
        ...
        while index < point:
            ...
            if next_index is not None:
                the_node = getattr (self, str(next_index))
                index += 1
    ...
    def remove(self, point):
        ...
        if self.the_size >= 2:
            ...
            if point == self.the_size - 1:
                ...
                next_index = the_node.next
                front_index = the_node.front
                the_node_index = getattr (self, str(next_index)).front
...
flag = 1
with open("./game_output2.txt", "w") as file:
    for n in range(50, 55):
        for m in range(50, 55):
            ...
            for i in range (1,11):
                ...
                while coffee_can.size() > 1:
                    ran_a = random.randint(0, coffee_can.size()-1)
                    bean_a = coffee_can.remove(ran_a)
                    ran_b = random.randint (0, coffee_can.size () - 1)
                    bean_b = coffee_can.remove(ran_b)
                    if bean_a == bean_b:
                ...
                file.write("Turn: "+ str(i) + "\t\t" + str(coffee_can))
                file.write("\n")
